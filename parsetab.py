...
_lr_productions = [
    ...
    ("lvalue -> IDENTIFIER", "lvalue", 1, "p_lvalue", "syntactic_interpreter.py", 126),
    ("lvalue -> ELGIO", "lvalue", 1, "p_lvalue", "syntactic_interpreter.py", 127),
    (
    ...
    ("empty -> <empty>", "empty", 0, "p_empty", "syntactic_interpreter.py", 184),
]
